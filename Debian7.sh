...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/cartoonn/autodebian7/master/conf/squid.conf"
...
cd
wget https://raw.githubusercontent.com/cartoonn/autodebian7/master/conf/menu
...
# User Status
cd
wget https://raw.githubusercontent.com/cartoonn/autodebian7/master/conf/status
chmod +x status
...
#ocs_panel
#cd
#wget https://raw.githubusercontent.com/cartoonn/autodebian7/master/OCS-Panel.sh
